...
function Index(props) {
    ...
    const handleEnableDisable = (id, active) => {
        ...
        if (check) {
            BrandModel.changeStatus(id, active).then( res => {
                alert(lang.saved);
                setLoading(true);
            })
        }
    ...
    return (
        <MasterLayout>
            <div className='page-header'>
                <Breadcrumb pageName='Nhãn hiệu' parentName='Nhãn hiệu' parentLink='brand' />
                            ...
                            <div className='card-body pt-0 background-horizontal pb-1'>
                                ...
                                <div className='col-6 col-md-3 col-lg-2 pr-1'>
                                        <div className='form-group input-group mb-0 pt-3'>
                                            <input type="text" name="title" placeholder="Tên" className="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
